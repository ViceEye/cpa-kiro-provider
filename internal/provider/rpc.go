	...
	return okEnvelope(map[string]any{
		...
		"metadata": map[string]any{
			...
			"ConfigFields": []any{
				...
				map[string]any{"Name": "login_mode", "Type": "enum", "EnumValues": []string{"kiro-browser", "organization-browser", "aws-device"}, "Description": "First-login flow. Organization browser starts the second-stage IAM Identity Center PKCE flow directly."},
				...
				map[string]any{"Name": "sso_start_url", "Type": "string", "Description": "AWS Builder ID or IAM Identity Center start URL used for first login."},
				map[string]any{"Name": "browser_redirect_uri", "Type": "string", "Description": "Kiro CLI-compatible browser callback URI. Defaults to http://localhost:3128."},
